...
kubectl wait --for=condition=Ready pod -l app=mysql -n devops-assignment3 --timeout=120s
...
kubectl wait --for=condition=Ready pod --all -n devops-assignment3 --timeout=180s
